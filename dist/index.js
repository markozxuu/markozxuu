...
var xml = __nccwpck_require__(578);
...
var escapeForXML = __nccwpck_require__(769);
...
__nccwpck_require__.d(__webpack_exports__, {
  "generateRSS": () => /* binding */ generateRSS
});
...
// EXTERNAL MODULE: ./node_modules/rss/lib/index.js
var lib = __nccwpck_require__(762);
var lib_default = /*#__PURE__*/__nccwpck_require__.n(lib);

// CONCATENATED MODULE: ./data/blog.json
const blog_namespaceObject = JSON.parse("[{\"title\":\"Rendering on the Web\",\"description\":\"We currently have a variety of strategies for representing our content\",\"og\":\"https://api.microlink.io/?adblock=false&meta=false&screenshot&element=%23screenshot&embed=screenshot.url&url=https%3A%2F%2Fcards.microlink.io%2F%3Fpreset%3Drauchg%26title%3DRendering%2Bon%2Bthe%2BWeb%26domain%3Dmarkozxuu.now.sh%26p%3D2gO9PD4KICA8Qm94CiAgICBhcz0naGVhZGVyJwogICAgc3g9e3sKICAgICAgcG9zaXRpb246ICdhYnNvbHV0ZScsCiAgICAgIHB0OiAnNDJweCcsCiAgICAgIHBsOiAnNDJweCcsCiAgICAgIGJnOiBxdWVyeS5iZywKICAgICAgY29sb3I6IHF1ZXJ5LmNvbG9yLAogICAgfX0KICA----%23\",\"slug\":\"pre-rendering\",\"date\":\"2020-05-18\",\"published\":true,\"author\":\"Markoz Peña\"}]");
// CONCATENATED MODULE: ./lib/utils/atom.ts
...
function generateRSS() {
    return __awaiter(this, void 0, void 0, function () {
        var feed, onlyPublishedPosts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    feed = new (lib_default())({
                        title: 'Markoz Peña',
                        site_url: 'https://markozxuu.now.sh',
                        feed_url: 'https://markozxuu.now.sh/atom.xml',
                    });
                    onlyPublishedPosts = blog_namespaceObject.filter(function (post) { return post.published === true; })
                        .reverse();
                    onlyPublishedPosts.map(function (post) {
                        var title = post.title, description = post.description, date = post.date, slug = post.slug, author = post.author;
                        feed.item({
                            title: title,
                    ...
                    return [4 /*yield*/, promises_default().writeFile('./public/atom.xml', feed.xml({ indent: true }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
